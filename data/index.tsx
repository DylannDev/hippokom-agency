...
export const contactInfo = [
  ...
  },
  {
    ...
    title: "Whatsapp",
    content: "+33 6 37 49 56 78",
    link: "tel:+33637495678",
  },
];
...
export const caseStudiesArticles = [
  {
    ...
    highlights: [
      ...
      { value: "+98%", label: "d’interactions stories et sondages" },
    ],
    category: "Communication Événementielle",
    image: "/ak-experience.jpg",
    content: `
      <h3>Le contexte</h3>
      <p>AK Expérience est une agence événementielle 100 % caribéenne, spécialisée en ingénierie culturelle et en management de projet. Elle accompagne ses clients dans la conception et l’orchestration d’expériences immersives, mêlant culture, émotion et storytelling.</p>
      <p>Dans le cadre de La Rencontre du Monde Économique organisée par le MEDEF Martinique, AK Expérience a sollicité Hippô’Kom pour piloter la stratégie digitale de l’événement, avec un objectif clair : renforcer la visibilité, engager les participants, et prolonger l’impact au-delà du jour J.</p>
  
      <h3>Le challenge</h3>
      <p>Malgré la notoriété du MEDEF Martinique, sa présence digitale restait très discrète, peu engageante, et surtout mal alignée avec la dynamique réelle de ses actions terrain. L'événement risquait de passer inaperçu sur les réseaux sociaux, faute d'une stratégie claire.</p>
      <p>Le défi : créer en peu de temps une communication qui informe, engage, et crée du lien, aussi bien avec les participants sur place qu’avec la communauté en ligne.</p>
  
      <h3>La solution</h3>
      <p>Hippô’Kom a conçu une stratégie Instagram orientée conversion et engagement en 3 temps : avant, pendant, et après l’événement.</p>
  
      <h4>Avant l’événement :</h4>
      <ul>
        <li>Création de contenus informatifs et visuels attractifs</li>
        <li>Mise en avant claire du lien d’inscription</li>
        <li>Intégration de CTA, stories teaser et sondages interactifs</li>
      </ul>
  
      <h4>Pendant le jour J :</h4>
      <ul>
        <li>Couverture live de l’événement via stories et posts en temps réel</li>
        <li>Valorisation des temps forts et des intervenants</li>
        <li>Animation phygitale : interactions simultanées avec les participants sur site et en ligne</li>
      </ul>
  
      <h4>Après l’événement :</h4>
      <ul>
        <li>Diffusion de contenus récapitulatifs (vidéos, carrousels)</li>
        <li>Poursuite de l’engagement avec la communauté</li>
        <li>Renforcement de la visibilité et prolongation de l’impact</li>
      </ul>
  
      <h3>Résultats obtenus</h3>
      <ul>
        <li>Hausse notable du taux d’interactions sur les stories</li>
        <li>Croissance de la communauté pendant et après l’événement</li>
        <li>Engagement renforcé aussi bien sur le terrain qu’en ligne</li>
        <li>Visibilité prolongée au-delà du jour J, grâce à un contenu réutilisable</li>
        <li>Satisfaction client élevée malgré un temps de préparation réduit</li>
      </ul>
  
      <h3>Pourquoi faire appel à Hippô’Kom pour votre communication événementielle ?</h3>
      <p>Ce projet démontre une chose : la puissance d’une stratégie digitale bien pensée, même avec peu de temps. Hippô’Kom ne se contente pas de “poster” : nous construisons une expérience phygitale, où chaque story, chaque visuel, chaque interaction participe à l’impact global de l’événement.</p>
      <p>Nous vous aidons à transformer votre présence en ligne en véritable levier d’engagement, de notoriété et de performance, avant, pendant et après vos événements.</p>
  
      <h3>Conclusion</h3>
      <p>En un temps record, la stratégie déployée par Hippô’Kom a permis au MEDEF Martinique de gagner en visibilité, en interaction et en crédibilité digitale. Un exemple concret d’une communication événementielle agile, créative et orientée résultats.</p>
    `,
  },
  {
    ...
    highlights: [
      ...
      {
        value: "+1",
        label: "identité de marque reconnaissable",
      },
    ],
  ...
  <li>Structurer sa présence numérique,</li>
  <li>Inspirer davantage de confiance auprès de ses prospects et partenaires.</li>
  </ul>
  ...
  <ul>
    ...
    <li>Choix d’une palette de couleurs adaptée à la psychologie du métier : solidité, rigueur, fiabilité</li>
    <li>Rédaction d’une charte graphique claire et réutilisable sur tous les supports (digitaux et print)</li>
    <li>Déclinaisons pour Instagram, site web, carte de visite, etc.</li>
  </ul>
  ...
  <ul>
    ...
    <li>Des retours clients positifs, plus de commentaires, plus de prises de contact</li>
    <li>Une cliente qui se sent enfin représentée par sa communication</li>
  </ul>
...
`,
  ...
  },
  {
    ...
    client: "Festival du Bien Manger, Bien Bouger",
    service: "Communication événementielle multicanal",
    highlights: [
    ...
    content: `
      ...
      <ul>
        ...
        <li>Les supports de communication étaient inexistants,</li>
        <li>L’événement risquait de passer inaperçu sans une mise en lumière forte, cohérente et réactive.</li>
      </ul>
      ...
      <ul>
        <li>Stratégie de communication globale sur plusieurs canaux : Instagram, Facebook, WhatsApp, supports imprimés</li>
        <li>Création de visuels événementiels (affiches, stories, reels, goodies, vidéos)</li>
        <li>Mise en place d’un jeu concours en amont pour générer de l’engagement et du trafic physique</li>
        <li>Captation photo et vidéo professionnelle le jour J, pour prolonger la visibilité post-événement</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Plus de 80 participants</strong> présents sur les stands santé et nutrition</li>
        <li>100 % des stands occupés pendant toute la durée du festival</li>
        <li>Taux d’engagement élevé, grâce à une communication authentique, locale et participative</li>
      </ul>
      ...
      <ul>
        ...
        <li>on bâtit une vraie narration autour de votre action,</li>
        <li>et on connecte avec votre audience par le bon canal, au bon moment.</li>
      </ul>
...
export const faqHomepage = [
  {
    id: "1",
    question:
      "Pourquoi investir dans une stratégie de communication digitale sur-mesure ?",
    answer:
      "Une stratégie personnalisée vous permet de toucher la bonne audience, au bon moment, avec le bon message. Contrairement aux actions génériques, elle s’aligne sur vos objectifs business pour générer des résultats concrets : visibilité locale, notoriété, prises de contact, ventes.",
  },
  {
    id: "2",
    question:
      "Comment mesurer le retour sur investissement (ROI) de votre accompagnement ?",
    answer:
      "Nous mettons en place des indicateurs clairs dès le début : nombre d’abonnés, engagement, trafic web, demandes entrantes, visibilité locale… Chaque action est suivie et analysée pour prouver son impact sur votre activité.",
  },
  {
    id: "3",
    question: "Combien de temps faut-il pour obtenir des résultats visibles ?",
    answer:
      "Cela dépend de votre point de départ, de vos objectifs et de votre régularité. En moyenne, nos clients constatent des premiers résultats entre 1 et 3 mois (croissance de communauté, visibilité locale, prise de contact, etc.).",
  },
  {
    id: "4",
    question:
  ...
  {
    id: "5",
    question: "Faites-vous uniquement du community management ?",
    answer:
      "Notre accompagnement va bien au-delà : nous créons des identités visuelles fortes, des campagnes publicitaires ciblées, des sites web sur-mesure, de la communication événementielle… Notre but est d’aligner votre image à vos ambitions.",
  },
  {
    id: "6",
    question:
      "En quoi Hippô'kom se différencie des autres agences de communication ?",
    answer:
      "Nous combinons stratégie, culture locale, sens du terrain et accompagnement humain. Chaque client bénéficie d’un suivi personnalisé, d’une ligne éditoriale claire et d’une vraie montée en gamme de son image. Pas de solutions toutes faites, mais des stratégies qui vous ressemblent.",
  },
  {
    id: "7",
    question:
      "Je n’ai pas le temps de gérer mes réseaux, pouvez-vous tout prendre en charge ?",
    answer:
      "Oui. C’est justement notre force : on s’occupe de tout. De la création des contenus à leur publication, en passant par le planning, la stratégie, la modération et le suivi des performances. Vous restez informé, sans être débordé.",
  },
  {
    id: "8",
    question:
      "Est-ce que vous proposez des audits avant de commencer une collaboration ?",
    answer:
      "Oui. Chaque mission débute par un audit gratuit de votre communication actuelle : réseaux sociaux, site, visuels, stratégie… Cela nous permet de cibler vos axes d’amélioration et de bâtir un plan d’action sur-mesure.",
  },
];
